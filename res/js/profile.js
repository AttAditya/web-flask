	...
	return `
		<div class="column is-full">
			<a href="/a/${data.id}" class="box columns m-2 mb-1">
				<div class="column">
					<img src="${data.thumbnail}" alt="${data.name}" loading="lazy" onerror="this.src='${data.thumbnail}';" style="aspect-ratio: 1200/628; object-fit: contain;" onerror="this.src='${data.thumbnail}';">
				</div>
