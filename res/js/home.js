...
function display_data(data) {
	for (let article_data of data.headlines) {
		document.getElementById("headlines").innerHTML += create_card(article_data);
	}
	for (let article_data of data.recents) {
		document.getElementById("recents").innerHTML += create_card(article_data);
	}
}
